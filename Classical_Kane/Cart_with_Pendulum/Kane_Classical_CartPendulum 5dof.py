...
import csv
import time
file_path = "tempi_di_esecuzione_cartpendulum_5dof_AmdRyzen.csv"
tempi = []
...
for i in range(10):
   ...
   m_h = 7                   # Number of constraints present 
   ...
   C.orient_body_fixed(N, (q5,0,0),'zyx')                                     #Defining the cart ref. frame as rotated of 0° wrt the Inertial. By doing so, i tell the code that the two frames have their axes alligned                        
