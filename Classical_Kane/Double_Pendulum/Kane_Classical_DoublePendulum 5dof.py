...
import csv
import time
file_path = "tempi_di_esecuzione_doublependulum_5dof_AmdRyzen.csv"
tempi = []
...
for i in range(10):
   ...
   O.set_pos(O, 0*P1.x + q5*P1.y + 0*P1.z)                     # Setting point O as the origin of the pendulum 1 ref. frame
