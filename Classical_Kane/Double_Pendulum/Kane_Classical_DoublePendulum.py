...
# import csv
# import time
# file_path = "tempi_di_esecuzione_doublependulum_2dof_Inteli7.csv"
# tempi = []
...
P1.orient_axis(N, -(sy.pi/2 - q1), N.z)                                     #Defining the pendulum 1 ref. frame as rotated of q1 wrt the Inertial. By doing so, i tell the code that the two frames have their axes alligned
P2.orient_axis(P1, q2, P1.z)                                   #Defining the pendulum 2 ref. frame as rotated of q2 wrt to pendulum 2 ref. frame
