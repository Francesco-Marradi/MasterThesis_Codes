...
with open('Dynamical_Matrices_1arm_fixedbus_torqueapplied.json', 'r') as json_file:
    data_Mat_Dyn = json.load(json_file)

with open('Kinematical_Matrices_1arm_fixedbus_torqueapplied.json', 'r') as json_file:
...
solution = solve_ivp(system, t_span, y0, t_eval=t_eval, vectorized=False, method='RK45', rtol=1e-5, atol=1e-7, dense_output=True)

'''
# Extraction of results
u4_solution = solution.y[0]
u7_solution = solution.y[1]
u10_solution = solution.y[2]
u13_solution = solution.y[3]

q4_solution = solution.y[4]
q7_solution = solution.y[5]
q10_solution = solution.y[6]
q13_solution = solution.y[7]
...
plt.subplot(4, 1, 1)
plt.plot(solution.t, u4_solution*(180/np.pi), label="B11 body deploying velocity",color='r')
plt.xlabel("t")
...
plt.subplot(4, 1, 2)
plt.plot(solution.t, u7_solution*(180/np.pi), label="B21 body deploying velocity", color='g')
plt.xlabel("t")
plt.ylabel("Deploying velocity [deg/s]")
plt.grid(True)
plt.legend()
...
plt.subplot(4, 1, 3)
plt.plot(solution.t, u10_solution*(180/np.pi), label="B31 body deploying velocity", color='b')
plt.xlabel("t")
plt.ylabel("Deploying velocity [deg/s]")
plt.grid(True)
plt.legend()
...
plt.subplot(4, 1, 4)
plt.plot(solution.t, u13_solution*(180/np.pi), label="B41 body deploying velocity", color='k')
plt.xlabel("t")
plt.ylabel("Deploying velocity [deg/s]")
plt.grid(True)
plt.legend()
...
plt.figure(figsize=(10, 6))
plt.subplot(4, 1, 1)
plt.plot(solution.t, q4_solution*(180/np.pi), label="B11 body deploying angle",color='r')
plt.xlabel("t")
...
plt.subplot(4, 1, 2)
plt.plot(solution.t, q7_solution*(180/np.pi), label="B21 body deploying angle", color='g')
plt.xlabel("t")
plt.ylabel("Deploying angle [deg/s]")
plt.grid(True)
plt.legend()
...
plt.subplot(4, 1, 3)
plt.plot(solution.t, q10_solution*(180/np.pi), label="B31 body deploying angle", color='b')
plt.xlabel("t")
plt.ylabel("Deploying angle [deg/s]")
plt.grid(True)
plt.legend()
...
plt.subplot(4, 1, 4)
plt.plot(solution.t, q13_solution*(180/np.pi), label="B41 body deploying angle", color='k')
plt.xlabel("t")
plt.ylabel("Deploying angle [deg/s]")
plt.grid(True)
plt.legend()
...
with open('solution_1arm_fixedbus_torqueapplied.json', 'w') as f:
