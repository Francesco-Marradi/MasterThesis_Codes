...
with open('Dynamical_Matrices_1arm_torqueapplied.json', 'r') as json_file:
    data_Mat_Dyn = json.load(json_file)

with open('Kinematical_Matrices_1arm_torqueapplied.json', 'r') as json_file:
...
q1, q2, q3, q4, q7, q10, q13, q52, q53, q54 = sy.symbols('q1 q2 q3 q4 q7 q10 q13 q52 q53 q54')
u1, u2, u3, u4, u7, u10, u13, u52, u53, u54 = sy.symbols('u1 u2 u3 u4 u7 u10 u13 u52 u53 u54')
...
all_symbolic_var = (u1,u2,u3,u4,u7,u10,u13,u52,u53,u54,q1,q2,q3,q4,q7,q10,q13,q52,q53,q54,T11,T21,T31,T41)
...
def system(t, State_Vector):
    ...
    Mass_Matrix_eval = Mass_Matrix_lambdified(u1,u2,u3,u4,u7,u10,u13,u52,u53,u54,q1,q2,q3,q4,q7,q10,q13,q52,q53,q54,T11,T21,T31,T41)
    Forcing_Vector_eval = Forcing_Vector_lambdified(u1,u2,u3,u4,u7,u10,u13,u52,u53,u54,q1,q2,q3,q4,q7,q10,q13,q52,q53,q54,T11,T21,T31,T41)
...
# Initial conditions
     # u1  u2    u3   u4  u7   u10  u13  u52  u53  u54   q1   q2  q3    q4   q7  q10  q13  q52  q53  q54  
...
with open('solution_1arm_torqueapplied.json', 'w') as f:
