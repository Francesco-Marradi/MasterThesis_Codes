...
with open('Matrix_Kane/Kane_MatrixForm_Cart_with_Pendulum/Dynamical_Matrices_Cart_with_Pendulum.json', 'r') as json_file:
    data_Mat_Dyn = json.load(json_file)


# Reading the Json file
with open('Polynomial_Regression/Cart_with_Pendulum/Results/Cart_with_Pendulum_PolyInterp_R0999.json', 'r') as json_file:
...
T = sy.symbols('T')                # Torque applied [N/m]
...
with open('difference_matrices_cart.json', 'w') as f:
