...
with open('solution_spinningspacecraft.json', 'r') as f:
...
def update(frame):
    ...
    gencoord_active = sy.Matrix([q1_sol[frame], q2_sol[frame], q3_sol[frame], q4_sol[frame], 0, 0, q7_sol[frame], 0, 0, q10_sol[frame], 0, 0, q13_sol[frame], 0, 0, 0, 0, q18_sol[frame], 0, 0, q21_sol[frame], 0, 0, q24_sol[frame], 0, 0, q27_sol[frame], q28_sol[frame], 0, 0, q31_sol[frame], 0, 0, q34_sol[frame], 0, 0, q37_sol[frame], 0, 0, 0, 0, q42_sol[frame], 0, 0, q45_sol[frame], 0, 0, q48_sol[frame], 0, 0, q51_sol[frame], q52_sol[frame], q53_sol[frame], q54_sol[frame]])
